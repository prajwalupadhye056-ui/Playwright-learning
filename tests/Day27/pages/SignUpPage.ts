...
export class SignupPage
{
    ...
    constructor(page:Page) //is used to receive the Playwright Page object 
    //and make it available inside the Page Object class, so we can interact with the browser 
    // through this.page.
    {
    this.page=page;
