...
//await page.goto("http://127.0.0.1:5500/apps/pw-locators-demo-app.html")
  ...
  // For interactive elements like button, a, input, etc. use role locators.
      ...
      //const welcomeText1=page.getByText('Welcome, John! 👋',{exact:true})  // Exact math/ default
      //const welcomeText2=page.getByText('Welcome, John',{exact:false})  // Exact math/ default
