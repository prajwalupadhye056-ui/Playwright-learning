...
test('Hard Assertions Example', async ({ page }) => {
    ...
    await page.goto('https://demowebshop.tricentis.com/');
     ...
     //1 -This assertion will fail and remaining assertions will not execute
...
test('Soft Assertions Example', async ({ page }) => {
    ...
    //1
    await expect.soft(page).toHaveTitle('Demo Web Shop2'); //Marked as failed
    //other assertions will continue
