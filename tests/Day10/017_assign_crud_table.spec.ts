...
test('Validate CRUD table operations', async({page}) =>{
    ...
    // ==========================================================
        ...
        const heading=page.locator('h3',{ hasText:'Web Table with CRUD' })
        ...
        await expect(searchInput).toHaveText('Alice')
        ...
        page.once('dialog', dialog => dialog.accept()); //This will accept the 
       // confirmation dialog after clicking on 'Delete' button.
       ...
       await expect(crudTable.locator('tbody tr')).toHaveCount(2)
        ...
        await expect(
                crudTable.locator('tbody tr', { hasText: 'New' })).toBeVisible();
         
        await expect(
                crudTable.locator('tbody tr', { hasText: 'Dev' }) ).toBeVisible();
