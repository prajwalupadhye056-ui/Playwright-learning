...
async function selectDate(page: Page, targetYear: string, targetMonth: string, targetDate: 
  string) {
 ...
 */
  ...
  await page.locator('table.ui-datepicker-calendar a', { hasText: targetDate }).first()
  .click(); 
