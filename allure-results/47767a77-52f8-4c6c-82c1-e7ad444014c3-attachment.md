...
- Name: Day29\077_Visual_snapshot_testing.spec.ts >> Visual test
- Location: tests\Day29\077_Visual_snapshot_testing.spec.ts:12:5
...
Call log:
  ...
  - fonts loaded
  - 29030 pixels (ratio 0.04 of all image pixels) are different.
  - waiting 100ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 859 pixels (ratio 0.01 of all image pixels) are different.
  - waiting 250ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 7184 pixels (ratio 0.01 of all image pixels) are different.
      ...
      - generic [ref=e138]:
        ...
        - generic [ref=e185]:
            ...
            - generic [ref=e209]:
              - heading [level=2] [ref=e210]:
                - link "14.1-inch Laptop" [ref=e211] [cursor=pointer]:
                  - /url: /141-inch-laptop
              - generic "1739 review(s)" [ref=e212]
              - generic [ref=e215]:
                - generic [ref=e216]: "1590.00"
            ...
            - generic [ref=e225]:
              - heading [level=2] [ref=e226]:
                - link "Build your own cheap computer" [ref=e227] [cursor=pointer]:
                  - /url: /build-your-cheap-own-computer
              - generic "934 review(s)" [ref=e228]
              - generic [ref=e231]:
                - generic [ref=e232]: "800.00"
          ...
          - generic [ref=e237]:
            ...
            - generic [ref=e241]:
              - heading [level=2] [ref=e242]:
                - link "Build your own computer" [ref=e243] [cursor=pointer]:
                  - /url: /build-your-own-computer
              - generic "437 review(s)" [ref=e244]
              - generic [ref=e247]:
                - generic [ref=e248]: "1200.00"
            ...
            - generic [ref=e257]:
              - heading [level=2] [ref=e258]:
                - link "Build your own expensive computer" [ref=e259] [cursor=pointer]:
                  - /url: /build-your-own-expensive-computer-2
              - generic "529 review(s)" [ref=e260]
              - generic [ref=e263]:
                - generic [ref=e264]: "1800.00"
            ...
            - generic [ref=e273]:
              - heading [level=2] [ref=e274]:
                - link "Simple Computer" [ref=e275] [cursor=pointer]:
                  - /url: /simple-computer
              - generic "417 review(s)" [ref=e276]
              - generic [ref=e279]:
                - generic [ref=e280]: "800.00"
...
```ts
  1  | 
  2  | // Step 1: capture the snapshot
  3  | 
  4  | // Step 2, 3, 4:   run the test
  5  | 
  6  | // toMatchSnapshot()
  7  | // toHaveScreenshot()
  8  | 
  ...
  10 | 
  11 | 
  12 | test("Visual test", async({page})=>{
  13 | 
  14 | await page.goto("https://demowebshop.tricentis.com/");
  15 | 
  16 | //Method 1:
  17 | 
  18 | //Full page snapshot
  19 | //expect(await page.screenshot()).toMatchSnapshot("homepage.png")
  20 | 
  21 | //compare snapshot of the element
  22 |  //const logo=page.locator("img[alt='Tricentis Demo Web Shop']");
  23 |  //expect(await logo.screenshot()).toMatchSnapshot("logo.png");
  24 | 
  25 |  //Method 2:
